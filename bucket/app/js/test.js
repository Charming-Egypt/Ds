        ...
        async function submitForm() {
            ...
            try {
                ...
                localStorage.setItem(`booking_${refNumber}`, JSON.stringify(formData));

                // Store payment URL in localStorage for reference
                localStorage.setItem(`paymentUrl_${refNumber}`, kashierUrl);
