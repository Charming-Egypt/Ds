...
// Original System Restored + Mobile Section Below Reviews
// ==========================================================================
...
async function submitForm() {
  ...
  try {
    ...
    const specialRequests = sanitizeInput(document.getElementById("specialRequests")?.value || '');
    
    let extraServicesStr = 'None';
    if (selectedTripType && tourTypes[selectedTripType]) {
    ...
    await sendBookingNotificationToSupplier({
      bookingId: refNumber,
      userName: username,
      userEmail: email,
      phone: phone,
...
// ========================================
// Mobile Booking - Show Below Reviews
// ========================================
